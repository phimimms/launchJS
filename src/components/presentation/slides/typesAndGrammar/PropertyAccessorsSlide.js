        ...
        return (
            <div className="slide-container novetta-bg">
                ...
                <div className="slide-content">
                    <ul>
                        <li>An object{rsquote}s properties are accessed via <code>object.property</code> or <code>object[{rsquote}property{rsquote}]</code></li>
                        ...
                        <ul>
                            ...
                            <li>For a setter: <code>obj.a = 1;</code></li>
                                <ul>
                                    ...
                                    <li>Results in a shadowed property in the object{rsquote}s prototype</li>
                                </ul>
                        </ul>
                    </ul>
                </div>
